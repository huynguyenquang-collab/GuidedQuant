...
export REDPAJAMA_USE_URL_LISTS="${REDPAJAMA_USE_URL_LISTS:-1}"
export REDPAJAMA_SUBSETS="${REDPAJAMA_SUBSETS:-common_crawl}"
export REDPAJAMA_FILES_PER_SUBSET="${REDPAJAMA_FILES_PER_SUBSET:-1}"
